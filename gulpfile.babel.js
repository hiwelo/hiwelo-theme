...
const paths = {
  ...
  src: {
    ...
    styles: {
      ...
      lessFiles: './resources/styles/**/*.less',
      sass: './resources/styles/styles.scss',
      sassFiles: './resources/styles/**/*.scss',
    },
    scripts: './resources/scripts/*.js',
    images: './resources/images/*.{png,jpg,jpeg,gif,svg}',
    fonts: './resources/fonts/*.{woff,woff2}',
    icons: './resources/icons/*.svg',
  },
  vendors: './node_modules',
  dist: {
    root: './assets',
    styles: './assets/styles',
    cssFiles: './assets/styles/*.css',
    cssMinFiles: `./assets/styles/*${project.conf.suffix}.css`,
